...
// WithoutRequireDigest disables enforcement of digest in parsed image.
func WithoutRequireDigest() ParseImageOption {
	return func(cfg *ParseImageConfig) error {
...
// WithoutStrict disables strict validation of image references and appends defaults.
func WithoutStrict() ParseImageOption {
	return func(cfg *ParseImageConfig) error {
		cfg.Strict = false
		return nil
	}
