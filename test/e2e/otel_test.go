...
func TestOTELTracing(t *testing.T) {
	...
	_ = command(t.Context(), t, "docker compose -f docker-compose.otel.yaml up -d jaeger")
	t.Cleanup(func() {
		_ = command(t.Context(), t, "docker compose -f docker-compose.otel.yaml down jaeger")
	})
